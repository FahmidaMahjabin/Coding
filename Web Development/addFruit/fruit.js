...
// 6.remove korar por id reset korte hobe i.e html fruitList ta abar reload hobe 
    ...
    $(document).ready(function(){
        $("button").click(function(){
            ...
            $("#rightPart").append(`<li id = ${listOfFruit.indexOf(fruit)}><i class="bi bi-cart"></i>${fruit}</li>`);
        ...
        //         3.newFruitHTML er sathe remove function ta attach korbo 
            ...
            var fruitId = listOfFruit.indexOf(fruit);
            console.log(fruitId);
            $(`#${listOfFruit.indexOf(fruit)} > i`).click(removeFruit);
    ...
    function removeFruit(){
        ...
        var newFruitsHTML = "";
        for(index in listOfFruit){
            newFruitsHTML += `<li id = ${index}><i class="bi bi-cart"></i>${listOfFruit[index]}</li>`;
    
        }
        $("#rightPart").html(newFruitsHTML);
        $("i").click(removeFruit)
